...
.bgimg {background-image: url("image/nhancuoi.jpg")}
.bgimg2 {background-image: url("image/hoacuoi.jpg")}
</style>
</head>
<body>

<!-- Header / Home-->
<header class="w3-display-container w3-wide bgimg w3-min" id="home">
  <div class="w3-display-middle w3-text-white w3-center">
    <h2>Thanh & Hiep</h2>
    <h3>Are getting married</h3>
    <h3><b>20.11.2022 </b></h3>
  </div>
  <style>
    h2 {color:black  }
  </style>
...
<div class="w3-bottom w3-hide-small">
  <div class="w3-bar w3-white w3-center w3-padding w3-opacity-min w3-hover-opacity-off">
    ...
    <a href="#us" style="width:25%" class="w3-bar-item w3-button">Thanh & Hiep </a>
...
<div class="w3-container w3-padding-64 w3-pale-red w3-grayscale-min" id="us">
  <div class="w3-content">
    <h1 class="w3-center w3-text-grey"><b>Thanh & Hiep </b></h1>
    <img class="w3-round w3-grayscale-min" src="/image/anhcuoi.jpg" style="width:100%;margin:32px 0">
...
<div class="w3-container w3-padding-64 w3-pale-red w3-grayscale-min w3-center" id="wedding">
  <div class="w3-content">
    ...
    <img class="w3-round-large w3-grayscale-min" src="/image/phongcuoi.jpg" style="width:100%;margin:64px 0">
    <div class="w3-row">
      <div class="w3-half">
        <h2>When</h2>
